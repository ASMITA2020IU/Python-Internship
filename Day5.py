...
#assign string value to class variable using method example
...
#assign string value to class variable using constructor example
'''class Myclass:
    name= ""
...
#define Child class2
class ChildClass2(MyParentClass1):  #Hierarchical Inheritance   
...
c2.child_method2()        #child class 2 method
